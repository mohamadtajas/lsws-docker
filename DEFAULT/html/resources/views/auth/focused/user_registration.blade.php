                                ...
                                <div class="">
                                    <form id="reg-form" class="form-default" role="form" action="{{ route('register') }}" method="POST">
                                        @if (get_setting('invite_system') == 1)
                                            <input type="hidden" name="invite_code" value="{{ request('invite_code') }}">
                                        @endif
                                        @csrf
                                        <!-- Name -->
                                        ...
                                        <ul class="list-inline social colored text-center mb-4">
                                            @if (get_setting('facebook_login') == 1)
                                                <li class="list-inline-item">
                                                    @if (get_setting('invite_system') == 1)
                                                    <a href="{{ route('social.login', ['provider' => 'facebook']) }}?invite_code={{request()->invite_code}}" class="facebook">
                                            ...
                                            @if(get_setting('google_login') == 1)
                                                <li class="list-inline-item">
                                                    @if (get_setting('invite_system') == 1)
                                                    <a href="{{ route('social.login', ['provider' => 'google']) }}?invite_code={{request()->invite_code}}" class="google">
                                            ...
                                            @if (get_setting('twitter_login') == 1)
                                                <li class="list-inline-item">
                                                    @if (get_setting('invite_system') == 1)
                                                    <a href="{{ route('social.login', ['provider' => 'twitter']) }}?invite_code={{request()->invite_code}}" class="twitter">
                                            ...
                                            @if (get_setting('apple_login') == 1)
                                                <li class="list-inline-item">
                                                    @if (get_setting('invite_system') == 1)
                                                    <a href="{{ route('social.login', ['provider' => 'apple']) }}?invite_code={{request()->invite_code}}" class="apple">
