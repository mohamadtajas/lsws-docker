    ...
    @section('content')
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{ translate('STB') }}</h5>
                    </div>
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                            @csrf
                            <input type="hidden" name="payment_method" value="stb">
                            <div class="form-group row">
                                <input type="hidden" name="types[]" value="STB_BASE_URL">
                                <div class="col-lg-4">
                                    <label class="col-from-label">{{ translate('STB_BASE_URL') }}</label>
                                </div>
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" name="STB_BASE_URL"
                                        value="{{ env('STB_BASE_URL') }}"
                                        placeholder="{{ translate('STB_BASE_URL') }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <input type="hidden" name="types[]" value="STB_ACCESS_TOKEN">
                                <div class="col-lg-4">
                                    <label class="col-from-label">{{ translate('STB_ACCESS_TOKEN') }}</label>
                                </div>
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" name="STB_ACCESS_TOKEN"
                                        value="{{ env('STB_ACCESS_TOKEN') }}"
                                        placeholder="{{ translate('STB_ACCESS_TOKEN') }}" required>
                                </div>
                            </div>

                            <div class="form-group row">
                                <input type="hidden" name="types[]" value="STB_SECRET_KEY">
                                <div class="col-lg-4">
                                    <label class="col-from-label">{{ translate('STB_SECRET_KEY') }}</label>
                                </div>
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" name="STB_SECRET_KEY"
                                        value="{{ env('STB_SECRET_KEY') }}"
                                        placeholder="{{ translate('STB_SECRET_KEY') }}" required>
                                </div>
                            </div>
