    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="carrier-form" action="{{route('carriers.update', $carrier->id)}}" method="POST">
                        ...
                        <div id="price_range_form">
                                ...
                                <tbody>
                                        ...
                                        @foreach ($carrier->carrier_ranges as $carrier_range)
                                            <td>
                                                <div class="input-group mb-2">
                                                    ...
                                                    <input type="number" class="form-control delimiter1"
                                                        name="delimiter1[]" value="{{ $carrier_range->delimiter1 }}"
                                                        step="0.01">
                                                </div>
                                            </td>
                                        @endforeach
                                        @if (count($carrier->carrier_ranges) == 0)
                                            <td>
                                                <div class="input-group mb-2">
                                                    ...
                                                    <input type="number" class="form-control delimiter1"
                                                        name="delimiter1[]" value="0.00" step="0.01">
                                                </div>
                                            </td>
                                        @endif
                                    </tr>
                                        ...
                                        <td>
                                            <div class="input-group mb-2">
                                                ...
                                                <input type="number" class="form-control delimiter2" name="delimiter2[]"
                                                    value="{{ $carrier_range->delimiter2 }}" step="0.01">
                                            </div>
                                        </td>
                                        @endforeach
                                        @if (count($carrier->carrier_ranges) == 0)
                                            <td>
                                                <div class="input-group mb-2">
                                                    ...
                                                    <input type="number" class="form-control delimiter2"
                                                        name="delimiter2[]" value="0.00" step="0.01">
                                                </div>
                                            </td>
                                        @endif
                                    </tr>
                                    ...
                                    @foreach ($zones as $key => $zone)
                                        <tr>
                                            ...
                                            @php
                                                $selected_zones = $carrier->carrier_range_prices
                                                    ->unique('zone_id')
                                                    ->pluck('zone_id')
                                                    ->toArray();
                                            @endphp
                                            <td>
                                                <input class="aiz-square-check zone_enable mt-2" type="checkbox"
                                                    ...
                                                    @if (in_array($zone->id, $selected_zones)) checked @endif>
                                            </td>
                                            @foreach ($carrier->carrier_ranges as $key => $carrier_range)
                                                @php
                                                    $carrier_range_price = $carrier_range->carrier_range_prices
                                                ...
                                                <td>
                                                    <div class="input-group mb-2">
                                                        ...
                                                        <input type="number" class="form-control shipping_cost"
                                                            ...
                                                            value="{{ $carrier_range_price->price ?? null }}"
                                                            placeholder="{{ translate('cost') }}"
                                                            @if (!in_array($zone->id, $selected_zones)) disabled @endif required>
                                                    </div>
                                                </td>
                                            @endforeach
                                            @if (count($carrier->carrier_ranges) == 0)
                            ...
                            <button type="button" class="btn btn-primary btn-sm"
                                id="addNewRange">{{ translate('Add new range') }}</button>
                        </div>


                        <div class="form-group mb-0 text-right">
                            <button type="submit" class="btn btn-primary" >{{ translate('Update Carrier Informations') }}</button>
                        </div>
                    </form>
