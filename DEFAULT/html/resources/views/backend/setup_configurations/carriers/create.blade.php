    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="carrier-form" action="{{route('carriers.store')}}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="carrier_name" value="{{ old('carrier_name') }}"
                        ...
                        <div class="form-group row">
                            <label class="col-md-2 col-from-label">{{ translate('Transit Time') }} <span
                                    class="text-danger">*</span></label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="transit_time" value="{{ old('transit_time') }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    ...
                                    <input type="hidden" name="logo" class="selected-files" value="" required>
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="shipping_type" onchange="freeShipping(this)" {{ old('shipping_type') == 1 ? 'checked' : ''}}>
                                    <span></span>
                                </label>
                            </div>
                        </div>
                        <div class="form-group row" id="billing_type_section">
                            ...
                            <div class="col-md-9">
                                <select class="form-control aiz-selectpicker" name="billing_type"
                                    ...
                                    <option value="weight_based" {{ old('billing_type') == 'weight_based' ? 'selected' : ''}}>{{ translate('According to Weight') }}</option>
                                    <option value="price_based" {{ old('billing_type') == 'price_based' ? 'selected' : ''}}>{{ translate('According to Price') }}</option>
                                </select>
                            </div>
                        </div>
