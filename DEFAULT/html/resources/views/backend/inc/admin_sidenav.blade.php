        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @canany(['view_all_orders', 'view_inhouse_orders','view_seller_orders','view_pickup_point_orders'])
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @can('orders_details')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('orders_details') }}" class="aiz-side-nav-link {{ areActiveRoutes(['orders_details'])}}">
                                        <span class="aiz-side-nav-text">{{translate('Orders Details')}}</span>
                                    </a>
                                </li>
                            @endcan
                    ...
                    @canany(['view_all_seller','seller_payment_history','view_seller_payout_requests','seller_commission_configuration','view_all_seller_packages','seller_verification_form_configuration'])
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                ...
                                @endcan
                                @can('view_trendyol_seller')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('sellers.trendyol') }}" class="aiz-side-nav-link {{ areActiveRoutes(['sellers.trendyol'])}}">
                                            <span class="aiz-side-nav-text">{{ translate('All Trendyol Seller') }}</span>
                                        </a>
                                    </li>
                                @endcan
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @can('wallet_transaction_report')
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('invitation-report.index') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('Invitation History') }}</span>
                                    </a>
                                </li>
                            @endcan
                        </ul>
                ...
                @canany(['general_settings','features_activation','language_setup','currency_setup','vat_&_tax_setup',
                        ...
                        'google_firebase_setting','shipping_configuration','shipping_country_setting','manage_shipping_states','manage_shipping_cities','manage_zones','manage_carriers' , 'trendyol_tax' , 'trendyol_black_list'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <div class="aiz-side-nav-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @can('features_activation')
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('app.settings')}}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{translate('App Settings')}}</span>
                                    </a>
                                </li>
                            @endcan
                            @can('external_providers')
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('external_providers.index')}}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{translate('External Providers')}}</span>
                                    </a>
                                </li>
                            @endcan
                            @can('language_setup')
                            ...
                            @can('trendyol_tax')
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('tax.trendyol')}}" class="aiz-side-nav-link {{ areActiveRoutes(['tax.trendyol'])}}">
                                        <span class="aiz-side-nav-text">{{translate('Trendyol tax')}}</span>
                                    </a>
                                </li>
                            @endcan
                            @can('trendyol_black_list')
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('trendyol.black_list')}}" class="aiz-side-nav-link {{ areActiveRoutes(['trendyol.black_list'])}}">
                                        <span class="aiz-side-nav-text">{{translate('Trendyol Black List')}}</span>
                                    </a>
                                </li>
                            @endcan
