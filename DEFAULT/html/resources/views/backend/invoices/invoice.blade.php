			...
			<table class="padding text-left small border-bottom">
				<thead>
	                <tr class="gry-color" style="background: #eceff4;">
                        ...
                        <th width="30%" class="text-left">{{ translate('Tracking') }}</th>
				...
				<tbody class="strong">
	                @foreach ($order->orderDetails as $key => $orderDetail)
		                @if ($orderDetail->product != null || $orderDetail->trendyol == 1)
							<tr class="">
								<td>
                                    ...
                                    @php
                                    $product = trendyol_product_details(trendyol_account_login() , $orderDetail->product_id ,$orderDetail->urunNo);
                                    @endphp
                                    {{ $product['name'] }}
                                    @if($orderDetail->variation != null) ({{ $orderDetail->variation }}) @endif
                                    @endif
                                ...
                                <td class="">{{ $orderDetail->tracking_code }}</td>
