                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-xxl-9">
                                                    <input type="number" class="form-control" name="weight"
                                                        step="0.01" value="{{ old('weight', 0.0) }}"
                                                        placeholder="0.00">
                                                </div>
                                            </div>
                                            <!-- Quantity -->
                                            <div class="form-group row">
                                                ...
                                                <div class="col-xxl-9">
                                                    <input type="number" lang="en" class="form-control"
                                                        name="min_qty" value="{{ old('min_qty', 1) }}" min="1">
                                                    <small
                                        ...
                                        <div class="col-md-9">
                                            <label class="aiz-switch aiz-switch-success mb-0 d-block">
                                                <input type="checkbox" name="todays_deal" value="1"
                                                    @if (old('todays_deal')) checked @endif>
                                                <span></span>
                                            </label>
                                            <small
                                            ...
                                            <select class="form-control aiz-selectpicker" name="flash_deal_id"
                                                ...
                                                @foreach (\App\Models\FlashDeal::where('status', 1)->get() as $flash_deal)
                                                    <option value="{{ $flash_deal->id }}"
                                                        @if (old('flash_deal_id') == $flash_deal->id) selected @endif>
                                                        {{ $flash_deal->title }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xxl-9">
                                            <input type="number" name="flash_discount"
                                                value="{{ old('flash_discount', 0) }}" min="0" step="0.01"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <!-- Discount Type -->
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xxl-9">
                                            <select class="form-control aiz-selectpicker" name="flash_discount_type"
                                                ...
                                                <option value="amount" @selected(old('flash_discount_type') == 'amount')>
                                                    {{ translate('Flat') }}</option>
                                                <option value="percent" @selected(old('flash_discount_type') == 'percent')>
                        ...
                        <div class="tab-pane fade" id="price_and_stocks" role="tabpanel"
                            ...
                            <div class="bg-white p-3 p-sm-2rem">
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="form-group row gutters-5">
                                        ...
                                        <div class="col-md-8">
                                            <select class="form-control aiz-selectpicker" data-live-search="true"
                                                ...
                                                @if (old('colors_active') == 0) disabled @endif>
                                                @foreach (\App\Models\Color::orderBy('name', 'asc')->get() as $key => $color)
                                                    <option value="{{ $color->code }}"
                                                        data-content="<span><span class='size-15px d-inline-block mr-2 rounded border' style='background:{{ $color->code }}'></span><span>{{ $color->name }}</span></span>"
                                                        @selected(in_array($color->code, old('colors', [])))></option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-md-1">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="number" lang="en" min="0"
                                                value="{{ old('unit_price', 0) }}" step="0.01"
                                    ...
                                    <!-- Currency -->
                                    <div class="form-group row">
                                        <label class="col-md-3 col-from-label">{{ translate('Currency') }} <span
                                                class="text-danger">*</span></label>
                                        <div class="col-md-6">
                                            <select class="form-control aiz-selectpicker" name="currency"
                                                ...
                                                @foreach ($currencies as $key => $currency)
                                                    <option value="{{ $currency->code }}"
                                                        @if ($currency->code == old('currency')) selected
                                                                @elseif(get_system_default_currency()->code == $currency->code) selected @endif>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="number" name="low_stock_quantity"
                                                value="{{ old('low_stock_quantity', 1) }}" min="0"
                                        ...
                                        <div class="col-md-9">
                                            <label class="aiz-switch aiz-switch-success mb-0">
                                                <input type="radio" name="stock_visibility_state" value="quantity"
                                                    @checked(old('stock_visibility_state', 'quantity') == 'quantity')>
                                                <span></span>
                                            </label>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-9">
                                            <label class="aiz-switch aiz-switch-success mb-0">
                                                <input type="radio" name="stock_visibility_state" value="text"
                                                    @checked(old('stock_visibility_state') == 'text')>
                                                <span></span>
                                            </label>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-9">
                                            <label class="aiz-switch aiz-switch-success mb-0">
                                                <input type="radio" name="stock_visibility_state" value="hide"
                                                    @checked(old('stock_visibility_state') == 'hide')>
                                                <span></span>
                                            </label>
                                        </div>
                                    </div>
