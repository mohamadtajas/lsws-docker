            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-2 col-from-label">{{ translate('Product File') }}  <span class="text-danger">*</span></label>
                            <div class="col-lg-8">
                                <div class="input-group" data-toggle="aizuploader" data-multiple="false">
                                    ...
                                    <input type="hidden" name="file_name" class="selected-files" value="{{ old('file_name') }}" required>
                                </div>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-2 col-from-label">{{ translate('Tags') }} <span class="text-danger">*</span></label>
                            <div class="col-lg-8">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label"
                                for="signinSrEmail">{{ translate('Main Images') }} <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label" for="signinSrEmail">{{ translate('Thumbnail Image') }} <span class="text-danger">*</span>
                        ...
                        @foreach (\App\Models\Tax::where('tax_status', 1)->get() as $tax)
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="number" lang="en" min="0" step="0.01" placeholder="{{ translate('Tax') }}" name="tax[]" class="form-control" required value="0">
                                </div>
                                <div class="col-md-2">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-2">
                                <select class="form-control aiz-selectpicker" name="discount_type">
                                    <option value="amount" @if(old('discount_type')=='amount' ) selected @endif>{{ translate('Flat') }}</option>
