        ...
        <div class="card rounded-0 shadow-none border">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input value="{{ old('name') }}" type="text" class="form-control rounded-0" name="name" placeholder="{{ translate('Product Name')}}" required>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control rounded-0" name="unit" placeholder="{{ translate('Product unit')}}" required value="{{ old('unit') }}">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <select class="form-control selectpicker" data-placeholder="{{ translate('Select a condition')}}" id="conditon" name="conditon" required>
                            <option value="new" @if(old('conditon') == 'new') selected @endif>{{ translate('New')}}</option>
                            <option value="used" @if(old('conditon') == 'used') selected @endif>{{ translate('Used')}}</option>
                        </select>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control rounded-0" name="location" placeholder="{{ translate('Location')}}" required value="{{ old('location') }}">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="true">
                            ...
                            <input type="hidden" name="photos" class="selected-files" required value="{{ old('photos') }}">
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <div class="input-group" data-toggle="aizuploader" data-type="image">
                            ...
                            <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                            <input type="hidden" name="thumbnail_img" class="selected-files" required value="{{ old('thumbnail_img') }}" >
                        </div>
                        <div class="file-preview box sm">
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <select class="form-control aiz-selectpicker" data-minimum-results-for-search="Infinity" name="video_provider">
                            <option value="youtube" @if(old('video_provider') == 'youtube') selected @endif >{{ translate('Youtube')}}</option>
                            <option value="dailymotion" @if(old('video_provider') == 'dailymotion') selected @endif >{{ translate('Dailymotion')}}</option>
                            <option value="vimeo" @if(old('video_provider') == 'vimeo') selected @endif >{{ translate('Vimeo')}}</option>
                        </select>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control rounded-0" name="video_link" placeholder="{{ translate('Video link')}}" value="{{ old('video_link') }}" >
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card rounded-0 shadow-none border">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="meta_title" class="form-control rounded-0" placeholder="{{ translate('Meta Title')}}" value="{{ old('meta_title') }}" >
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-2 col-from-label">{{translate('Description')}}</label>
                    <div class="col-md-10">
                        <textarea name="meta_description" rows="8" class="form-control rounded-0">{{ old('meta_description') }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
        ...
        <div class="card rounded-0 shadow-none border">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="number" lang="en" min="0" step="0.01" class="form-control rounded-0" name="unit_price" placeholder="{{ translate('Unit Price')}} ({{ translate('Base Price')}})" required value="{{ old('unit_price') }}" >
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card rounded-0 shadow-none border">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <div class="mb-3">
                            <textarea class="aiz-text-editor rounded-0" name="description" required>{{ old('description') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <div class="input-group" data-toggle="aizuploader" data-type="document">
                            ...
                            <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                            <input type="hidden" name="pdf" class="selected-files" value="{{ old('pdf') }}">
                        </div>
                        <div class="file-preview box sm">
                        </div>
                    </div>
