                                            ...
                                            <div class="col-md-8">
                                                <label class="aiz-megabox d-block bg-white mb-0">
                                                    <input type="radio" name="address_id" value="{{ $address->id }}"
                                                        @if ($address->set_default || $count == 0) checked @endif required>
                                                    <span class="d-flex p-3 aiz-megabox-elem border-0">
                                                        ...
                                                        <span class="flex-grow-1 pl-3 text-left">
                                                            ...
                                                            <div class="row">
                                                                <span
                                                                    class="fs-14 text-secondary col-3">{{ translate('First Name') }}</span>
                                                                <span
                                                                    class="fs-14 text-dark fw-500 ml-2 col">{{ $address->first_name }}</span>
                                                            </div>

                                                            <div class="row">
                                                                <span
                                                                    class="fs-14 text-secondary col-3">{{ translate('Last Name') }}</span>
                                                                <span
                                                                    class="fs-14 text-dark fw-500 ml-2 col">{{ $address->last_name }}</span>
                                                            </div>

                                                            <div class="row">
                                                                <span
                                                                    class="fs-14 text-secondary col-3">{{ translate('ID Number') }}</span>
                                                                <span
                                                                    class="fs-14 text-dark fw-500 ml-2 col">{{ $address->id_number }}</span>
                                                            </div>
