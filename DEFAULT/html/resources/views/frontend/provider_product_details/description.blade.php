<div class="bg-white mb-4 border p-3 p-sm-4">
    ...
    @if (count($detailedProduct['descriptions']) > 0 ||
            (isset($category) && $detailedProduct['digital'] == 1 && $category->meta_description != null))
    ...
    <div class="tab-content pt-0">
        @if (count($detailedProduct['descriptions']) > 0)
            ...
            <hr>
        @endif
        @if (isset($category) && $detailedProduct['digital'] == 1 && $category->meta_description != null)
            <!-- Description -->
            <div class="tab-pane fade active show" id="tab_default_1">
                <div class="py-3">
                    <div class="mw-100 overflow-hidden text-left aiz-editor-data">
                        <div class="row">
                            <div class="col-lg-2 col-12">
                                <img src="{{ $detailedProduct['thumbnail'] }}" width="80%">
                            </div>
                            <div class="col-lg-10 col-12 d-flex align-items-center flex-wrap">
                                <ul>
                                    @foreach (json_decode($category->meta_description) as $description)
                                        <li>{!! str_replace('\n' , '<br>' ,$description) !!}</li>
                                        <br>
                                    @endforeach
                                </ul>
                            ...
                            @foreach ($detailedProduct['attributes'] as $key => $attribute)
                                <div class="col-lg-6 col-12 px-4 my-2">
                                    <div class="row bg-light fw-900">
                                        ...
                                        <div class="col-6 px-3 py-3 d-flex justify-content-end text-muted">
                                            {{ $attribute }}
                                        </div>
                                    </div>
                                </div>
