                                            ...
                                            @if ($flash_deal_product->product != null && $flash_deal_product->product->published != 0)
                                                ...
                                                <div
                                                    ...
                                                    <a href="{{ $product_url }}"
                                                        ...
                                                        <!-- Image -->
                                                        <img src="{{ $flash_deal_product->product->thumbnail != null ? my_asset($flash_deal_product->product->thumbnail->file_name) : static_asset('assets/img/placeholder.webp') }}"
                        ...
                        @foreach ($featured_categories as $key => $category)
                            ...
                            <div
                                ...
                                <a href="{{ route('products.category', $category->slug) }}" class="d-block">
                                    <img src="{{ isset($category->bannerImage->file_name) ? my_asset($category->bannerImage->file_name) : static_asset('assets/img/placeholder.webp') }}"
