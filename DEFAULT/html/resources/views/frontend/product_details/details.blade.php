<div class="text-left">
    ...
    @if ($detailedProduct->main_category != null)
        <div class="d-flex flex-wrap align-items-center mb-3">
            ...
            <a href="{{ route('products.category', $detailedProduct->main_category->slug) }}"
                class="text-reset hov-text-primary fs-14 fw-700">{{ $detailedProduct->main_category->getTranslation('name') }}</a>
        </div>
    @endif
            ...
            @if ($detailedProduct->digital == 0)
                @if ($detailedProduct->external_link != null)
                    <a type="button" class="btn btn-primary buy-now fw-600 add-to-cart px-4 rounded-0"
                        href="{{ $detailedProduct->external_link }}" target="_blank">
