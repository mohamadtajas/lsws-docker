        ...
        <div class="position-relative logo-bar-area border-bottom border-md-nonea z-1025">
            <div class="container position-relative">
                <div class="d-flex align-items-center">
                    ...
                    <!-- Search field -->
                    <div class="flex-grow-1 front-header-search d-flex align-items-center bg-white mx-xl-4">
                        <div class="position-relative flex-grow-1 px-3 px-lg-0">
                            <form action="{{ request()->routeIs('products.brand') || request()->routeIs('products.category') ? url()->current() : route('search') }}" method="GET" class="stop-propagation">
                                <div class="d-flex position-relative align-items-center">
                                    <div class="d-lg-none" data-toggle="class-toggle"
                                        data-target=".front-header-search" >
                                        <button class="btn px-2" type="button" onclick="document.getElementsByClassName('typed-search-box')[0].classList.add('d-none');"><i
                                    ...
                                    <div class="search-input-box">
                                        <input type="text"
                                            ...
                                            value="{{ $query }}"
                                        @endisset
                                            placeholder="{{ translate('Search (selected website language)...') }}" autocomplete="off">
                    ...
                    <!-- Wishlist -->
                    <div class="d-none d-xl-block mr-3" style="margin-left: 13px;">
                    ...
                    <div class="d-none d-xl-block ml-auto mr-0">
                        @auth
                            <span
                                ...
                                <!-- Name -->
                                <h4 class="h5 fs-14 fw-700 text-dark ml-2 mb-0 notranslate">{{ $user->name }}</h4>
                            </span>
                        @else
                            <!--Login & Registration -->
            ...
            <!-- Loged in user Menus -->
            <div class="hover-user-top-menu position-absolute top-100 left-0 right-0 z-3 notranslate">
                <div class="container">
