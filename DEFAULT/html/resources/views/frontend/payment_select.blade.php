                        ...
                        <div class="card rounded-0 border shadow-none">
                            ...
                            <div class="card-body text-center px-4 pt-0">
                                <div class="row gutters-10">
                                    ...
                                    @endif
                                     <!-- Stb -->
                                    @if (get_setting('stb_payment') == 1)
                                    @php
                                    $completeOrder = true ;
                                    @endphp
                                        <div class="col-6 col-xl-3 col-md-4">
                                            <label class="aiz-megabox d-block mb-3">
                                                <input value="stb" class="online_payment" type="radio"
                                                    name="payment_option" checked>
                                                <span class="d-block aiz-megabox-elem rounded-0 p-3">
                                                    <img src="{{ static_asset('assets/img/cards/stb.png') }}"
                                                        class="img-fit mb-2" style="width:80%">
                                                    <span class="d-block text-center">
                                                        <span
                                                            class="d-block fw-600 fs-15">{{ translate('STB') }}</span>
                                                    </span>
                                                </span>
                                            </label>
                                        </div>
...
@section('script')
    <script type="text/javascript">
        ...
        function use_wallet() {
            ...
            newInput.attr('type', 'hidden'); // Hidden input
            newInput.attr('name', 'payment_option'); // Name attribute
            newInput.val('wallet');
            $('#checkout-form').append(newInput);
