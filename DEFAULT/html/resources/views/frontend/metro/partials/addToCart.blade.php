        ...
        <div class="col-lg-6">
            <div class="text-left">
                        ...
                        <div class="col-9">
                            <div class="">
                                ...
                                @if ($product->unit != null)
                                    <span
                                        class="opacity-70 ml-1 notranslate">/{{ $product->getTranslation('unit') }}</span>
                                @endif
                    ...
                    <div class="row no-gutters mt-3">
                        ...
                        <div class="col-9">
                            <div class="">
                                ...
                                @if ($product->unit != null)
                                    <span class="opacity-70 notranslate">/{{ $product->unit }}</span>
                                @endif
                            </div>
                        </div>
                    </div>
                ...
                <form id="option-choice-form">
                    ...
                    <input type="hidden" name="trendyol" value="0">
                    ...
                    @elseif($qty > 0)
                        @if ($product->external_link != null)
                            <a type="button" class="btn btn-soft-primary rounded-0 mr-2 add-to-cart fw-600"
                                ...
                                <span
                                    class="d-none d-md-inline-block">{{ $product->external_link_btn }}</span>
                            </a>
                        @endif
                        <button type="button" class="btn btn-primary rounded-0 buy-now fw-600 add-to-cart"
                            onclick="addToCart()">
