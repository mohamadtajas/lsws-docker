@if (count($suggestions_products) > 0)
                ...
                <div class="aiz-carousel arrow-none sm-gutters-16" data-items="6" data-xl-items="5" data-lg-items="4"
                    ...
                    @foreach ($suggestions_products as $key => $suggestion_product)
                        <div
                            ...
                            @include(
                                'frontend.' . get_setting('homepage_select') . '.partials.trendyol_product_box_1',
                                ['product' => $suggestion_product]
                            )
                        </div>
                    @endforeach
                </div>
