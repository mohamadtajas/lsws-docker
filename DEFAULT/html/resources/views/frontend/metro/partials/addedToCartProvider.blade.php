<div class="modal-body px-4 py-5 c-scrollbar-light">
    ...
    <div class="media mb-1">
        <img src="{{ static_asset('assets/img/placeholder.webp') }}" data-src="{{ $product['thumbnail'] }}"
            class="mw-100 mr-4 lazyload size-90px img-thumbnail rounded-0 " alt="Product Image" onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.webp') }}';">
            ...
            <div class="row mt-2">
                ...
                <div class="col-sm-9">
                    <div class="fs-16 fw-700 text-primary notranslate">
                        <strong>
                            {{ format_price(floatval($product['new_price'] * $cart->quantity)) }}
                        </strong>
                    </div>
                </div>
            </div>
