            ...
            <div class="card-body">
                ...
                <div class="row">
                    <label class="col-md-3 col-form-label"
                        for="bank_acc_name">{{ translate('Bank Account Name') }}</label>
                    <div class="col-md-9">
                ...
                <div class="row">
                    <label class="col-md-3 col-form-label"
                        for="bank_routing_no">{{ translate('Bank Routing Number') }}</label>
                    <div class="col-md-9">
                    ...
                    <div class="col-lg-4">
                        <div class="border p-3 pr-5 rounded mb-3 position-relative">
                            ...
                            <div class="dropdown position-absolute absolute-md-top-right pt-4 mr-1">
                                <button class="btn bg-secondary text-white px-1 py-1" type="button" data-toggle="dropdown">
                            ...
                            @if ($address->set_default)
                                <div class="position-absolute absolute-md-bottom-right pr-2 pb-3">
                    ...
                    <div class="modal-body">
                        <div class="p-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control mb-3 rounded-0" placeholder="John"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control mb-3 rounded-0" placeholder="Doe"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <input type="number" class="form-control mb-3 rounded-0" placeholder="999********"
                                        name="id_number" value="{{ old('id_number') }}" required dir="ltr">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2">
