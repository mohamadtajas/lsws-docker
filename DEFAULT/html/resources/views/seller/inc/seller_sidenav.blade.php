            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('seller.product_bulk_upload.trendyol') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['seller.product_bulk_upload.trendyol' , 'seller.product_bulk_upload.trendyol.get_products']) }}">
                                <span class="aiz-side-nav-text">{{ translate('Trendyol Product Bulk Upload') }}</span>
                            </a>
                        </li>
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('seller.orders.details') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['seller.orders.details']) }}">
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('seller.uploaded-files.index') }}"
                        class="aiz-side-nav-link {{ areActiveRoutes(['seller.uploaded-files.index']) }}">
