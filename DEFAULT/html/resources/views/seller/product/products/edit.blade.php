                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <select class="form-control aiz-selectpicker attribute_choice"
                                            ...
                                            @foreach (\App\Models\AttributeValue::where('attribute_id', $choice_option->attribute_id)->distinct()->get('value') as $row)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" placeholder="{{ translate('Unit price') }}" name="unit_price"
                                    class="form-control" value="{{ $product->getAttributes()['unit_price'] }}" required>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <select class="form-control aiz-selectpicker" name="currency" data-live-search="true"
                                    ...
                                    @foreach ($currencies as $key => $currency)
                                        <option value="{{ $currency->code }}" @selected($product->currency == $currency->code)>
