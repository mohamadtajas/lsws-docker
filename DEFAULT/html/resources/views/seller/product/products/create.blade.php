                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row" id="brand">
                            ...
                            <div class="col-md-8">
                                ...
                                <small>{{ translate('If you did not find your brand, contact with us') }}</small>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="number" lang="en" class="form-control" name="min_qty"
                                    value="{{ old('min_qty', 1) }}" min="1" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{ translate('Tags') }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" name="video_provider" id="video_provider">
                                    <option value="youtube"@selected(old('video_provider') == 'youtube')>{{ translate('Youtube') }}
                                    </option>
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{ translate('Unit price') }} <span
                                    class="text-danger">*</span></label>
                            <div class="col-md-6">
                                <input type="number" lang="en" min="0" value="{{ old('unit_price', 0) }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control aiz-date-range" name="date_range"
                                    value="{{ old('date_range') }}" placeholder="{{ translate('Select Date') }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <select class="form-control aiz-selectpicker" name="discount_type">
                                    <option value="amount" @selected(old('discount_type') == 'amount')>{{ translate('Flat') }}
                                    </option>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <input type="number" name="low_stock_quantity" value="{{ old('low_stock_quantity', 1) }}"
