...
@section('panel_content')
    ...
    <form class="" action="{{ route('seller.digitalproducts.store') }}" method="POST" enctype="multipart/form-data"
        id="choice_form">
        @csrf
        ...
        <div class="row gutters-5">
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label" for="signinSrEmail">{{ translate('Gallery Images') }} <span class="text-danger">*</span>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label" for="signinSrEmail">{{ translate('Thumbnail Image') }} <span class="text-danger">*</span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input type="number" lang="en" min="0" step="0.01"
                                    ...
                                    required value="{{ old('unit_price' , 0) }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control aiz-date-range" name="date_range"
                                    ...
                                    data-format="DD-MM-Y HH:mm:ss" data-separator=" to " autocomplete="off"  value="{{ old('date_range') }}">
                            </div>
                        </div>
                        <div class="form-group row">
