...
Route::group(['prefix' => "v3/auth", 'middleware' => ['app_language']], function () {
    ...
    Route::post('invite', 'App\Http\Controllers\Api\V2\AuthController@Invitation')->middleware('auth:sanctum');
...
Route::group(['prefix' => "v3", 'middleware' => ['app_language']], function () {
    Route::get('/app-version-info', 'App\Http\Controllers\Api\V2\BusinessSettingController@appVersionInfo');
    ...
    Route::group(['middleware' => ['app_user_unbanned', 'auth:sanctum']], function () {
        ...
        Route::post('payments/pay/wallet', 'App\Http\Controllers\Api\V2\WalletController@processPayment')->middleware('auth:sanctum', 'prevent.concurrent.requests');
        ...
        Route::get('/all-notifications', 'App\Http\Controllers\Api\V2\NotificationController@index')->middleware('auth:sanctum');
        ...
        Route::post('profile/generate-invite-code', 'App\Http\Controllers\Api\V2\ProfileController@generate_invite_code')->middleware('auth:sanctum');
        ...
        Route::get('wallet/recharge-sy-card', 'App\Http\Controllers\Api\V2\WalletController@recharge_sy_card')->middleware('auth:sanctum');

        Route::post('wallet/transfer', 'App\Http\Controllers\Api\V2\WalletController@transfer')->middleware('auth:sanctum');
        Route::get('wallet/transfer-fee', 'App\Http\Controllers\Api\V2\WalletController@transfer_fee')->middleware('auth:sanctum');
    ...
    Route::delete('delete-search-result', 'App\Http\Controllers\Api\V2\SearchSuggestionController@delete_search_result');
    ...
    Route::get('sub-categories/{provider}/{id}', 'App\Http\Controllers\Api\V2\SubCategoryController@provider')->name('subCategories.provider.index');
    ...
    Route::get('products/category/{provider}/{id}', 'App\Http\Controllers\Api\V2\ProductController@providerCategory')->name('api.products.category.provider');
    ...
    Route::get('products/suggestions', 'App\Http\Controllers\Api\V2\ProductController@suggestions');
    ...
    Route::get('products/{provider}/{id}', 'App\Http\Controllers\Api\V2\ProductController@provider')->name('products.provider');
