...
use App\Http\Controllers\Payment\StbController;
...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::get('/home/banner-section-3', 'homeBannerSection3')->name('home.banner.section3');
    ...
    Route::post('/home/section/suggestions-products', 'load_suggestions_product_section')->name('home.section.suggestions_products');
    ...
    Route::get('/product/{provider}/{id}', 'provider_product')->name('product.provider');
    Route::get('/tr-product/{id}/{urunNo?}', 'productTrendyol')->name('trendyol-product');
...
Route::controller(SearchController::class)->group(function () {
    ...
    Route::post('/delete-search-result', 'delete_search_result')->name('search.result.delete');
    Route::get('/category/{category_slug}', 'listingByCategory')->name('products.category');
    Route::get('/category/{provider}/{id}', 'listingByCategoryProvider')->name('products.category.provider');
...
Route::group(['middleware' => ['customer', 'verified', 'unbanned']], function () {
    ...
    Route::group(['prefix' => 'checkout'], function () {
        Route::controller(CheckoutController::class)->group(function () {
            ...
            Route::post('/payment', 'checkout')->name('payment.checkout')->middleware('prevent.concurrent.requests');
    ...
    Route::controller(WalletController::class)->group(function () {
        ...
        Route::post('/recharge-sy-card', 'recharge_sy_card')->name('wallet.recharge.sycard');
    ...
    Route::post('/product-review-modal-by-product', [ReviewController::class, 'product_review_modal_by_product'])->name('product_review_modal_by_product');
});
...
Route::controller(StbController::class)->group(function () {
    Route::get('/stb/payment-success', 'success')->name('stb.payment.success');
    Route::get('/stb/payment-cancel', 'cancel')->name('stb.payment.cancel');
});
