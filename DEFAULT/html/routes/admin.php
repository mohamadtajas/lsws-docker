...
use App\Http\Controllers\TrendyolCategoryController;
/*
  |--------------------------------------------------------------------------
  | Admin Routes
  |--------------------------------------------------------------------------
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function() {
    ...
    Route::controller(SellerController::class)->group(function () {
        ...
        Route::get('/sellers/trendyol/view', 'trendyol_sellers')->name('sellers.trendyol');
    });
    ...
    Route::controller(CustomerController::class)->group(function () {
        ...
        Route::get('/customer-info/{id}' , 'customer_info')->name('customer_info');
    });
    ...
    Route::controller(BusinessSettingsController::class)->group(function () {
        ...
        Route::get('/external-providers', 'external_providers')->name('external_providers.index');
    ...
    Route::controller(TrendyolCategoryController::class)->group(function () {
        Route::get('/tax-trendyol' , 'show_trendyol_tax')->name('tax.trendyol');
        Route::post('/tax-trendyol/key-value-store', 'key_value_store_trendyol_tax')->name('tax.trendyol.key_value_store');
        Route::get('/black-list-trendyol' , 'show_trendyol_black_list')->name('trendyol.black_list');
        Route::post('/update-black-list-trendyol', 'update_trendyol_black_list')->name('trendyol.black_list.update');
    });
    ...
    Route::controller(OrderController::class)->group(function () {
        ...
        Route::get('/orders-details', 'orders_details')->name('orders_details');
        ...
        Route::get('/trendyol_manual_order' , 'trendyol_manual_order')->name('trendyol_manual_order');
        Route::post('/trendyol_update_order_number' , 'trendyol_update_order_number')->name('trendyol_update_order_number');
        Route::post('/bulk_trendyol_manual_order' , 'bulk_trendyol_manual_order')->name('bulk_trendyol_manual_order');
        Route::post('/bulk_trendyol_update_order_number' , 'bulk_trendyol_update_order_number')->name('bulk_trendyol_update_order_number');
        ...
        Route::post('/order_detail/update_delivery_status', 'update_order_detail_delivery_status')->name('order_detail.update_delivery_status');
        ...
        Route::post('/edit-invoice-number/{id}', 'edit_invoice_number')->name('orders.edit_invoice_number');
    });
    ...
    Route::controller(ReportController::class)->group(function () {
        ...
        Route::get('/invitation-report', 'invitation_report')->name('invitation-report.index');
    });
