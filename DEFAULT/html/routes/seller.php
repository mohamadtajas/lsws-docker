...
Route::group(['namespace' => 'App\Http\Controllers\Seller', 'prefix' => 'seller', 'middleware' => ['seller', 'verified', 'user', 'prevent-back-history'], 'as' => 'seller.'], function () {
    ...
    Route::controller(ProductBulkUploadController::class)->group(function () {
        ...
        Route::get('/product-bulk-upload-trendyol', 'bulk_upload_trendyol_products')->name('product_bulk_upload.trendyol');
        Route::get('/product-bulk-upload-trendyol/get-products', 'bulk_upload_trendyol_get_products')->name('product_bulk_upload.trendyol.get_products');
        Route::post('/product-bulk-upload-trendyol/import-products', 'bulk_import_trendyol_get_products')->name('product_bulk_upload.trendyol.import');
    ...
    Route::controller(OrderController::class)->group(function () {
        ...
        Route::get('/orders-details' , 'orders_details')->name('orders.details');
    });
