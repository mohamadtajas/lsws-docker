...
use App\Http\Requests\Category\CategoriesByTypeRequest;
use App\Http\Requests\Category\LangRequest;
use App\Http\Requests\Category\SearchRequest;
use App\Http\Requests\Category\StoreRequest;
use App\Http\Requests\Category\UpdateFeaturedRequest;
...
class CategoryController extends Controller
{
    ...
    public function updateFeatured(UpdateFeaturedRequest $request)
    {
    ...
    public function categoriesByType(CategoriesByTypeRequest $request)
    {
        $categories = Category::where('parent_id', 0)
