...
use App\Http\Requests\Coupon\GetCouponFormRequest;
...
class CouponController extends Controller
{
    ...
    public function get_coupon_form(GetCouponFormRequest $request)
    {
    ...
    public function get_coupon_form_edit(GetCouponFormRequest $request)
    {
        if($request->coupon_type == "product_base") {
