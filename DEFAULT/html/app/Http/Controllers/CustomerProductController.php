...
use App\Http\Requests\CustomerProduct\LangRequest;
use App\Http\Requests\CustomerProduct\SearchRequest;
use App\Http\Requests\CustomerProduct\StoreRequest;
use App\Http\Requests\CustomerProduct\UpdatePublishedRequest;
use App\Http\Requests\CustomerProduct\UpdateStatusRequest;
...
class CustomerProductController extends Controller
{
    ...
    {
        $customer_product                       = CustomerProduct::where('user_id', Auth::user()->id)->findOrFail($id);
    ...
    public function updatePublished(UpdatePublishedRequest $request)
    {
        $product = CustomerProduct::findOrFail($request->id);
    ...
    public function customer_products_listing(SearchRequest $request)
    {
    ...
    public function search(SearchRequest $request)
    {
        ...
        if($brand_id != null){
            $conditions = array_merge($conditions, ['brand_id' => $brand_id , 'category_id' => $category_id]);
        }
