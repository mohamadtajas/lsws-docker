...
use App\Http\Requests\Attribute\LangRequest;
use App\Http\Requests\Attribute\StoreRequest;
use App\Http\Requests\Attribute\StoreValueRequest;
use App\Http\Requests\Attribute\UpdateRequest;
use App\Http\Requests\Color\SearchRequest;
...
class AttributeController extends Controller
{
    ...
    public function store_attribute_value(StoreValueRequest $request)
    {
    ...
    public function edit_attribute_value(string $id)
    {
        $attribute_value = AttributeValue::findOrFail($id);
        return view("backend.product.attribute.attribute_value.edit", compact('attribute_value'));
    }

    public function update_attribute_value(StoreValueRequest $request, string $id)
    {
        $attribute_value = AttributeValue::findOrFail($id);
    ...
    public function destroy_attribute_value(string $id)
    {
    ...
    public function colors(SearchRequest $request)
    {
        $sort_search = null;
    ...
    public function store_color(ColorStoreRequest $request)
    {
        $request->validate([
            'name' => 'required',
     ...
     * @return \Illuminate\Http\Response
     */
    public function update_color(ColorStoreRequest $request, string $id)
    {
        $color = Color::findOrFail($id);
