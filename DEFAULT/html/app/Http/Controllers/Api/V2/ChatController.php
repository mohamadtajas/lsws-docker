...
use App\Http\Requests\Conversation\InsertMessageRequest;
...
class ChatController extends Controller
{
    ...
    public function insert_message(InsertMessageRequest $request)
    {
        $message = new Message;
    ...
    public function create_conversation(StoreRequest $request)
    {
