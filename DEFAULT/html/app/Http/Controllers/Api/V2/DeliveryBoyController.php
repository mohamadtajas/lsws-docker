...
use App\Http\Requests\DeliveryBoy\ChangeDeliveryStatusRequest;
...
class DeliveryBoyController extends Controller
{
    ...
    public function dashboard_summary(string $id)
    {
    ...
    public function assigned_delivery(string $id)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function picked_up_delivery(string $id)
    {
        $order_query = Order::query();
     ...
     * @return \Illuminate\Http\Response
     */
    public function on_the_way_delivery(string $id)
    {
        $order_query = Order::query();
     ...
     * @return \Illuminate\Http\Response
     */
    public function completed_delivery(string $id)
    {
        $order_query = Order::query();
     ...
     * @return \Illuminate\Http\Response
     */
    public function pending_delivery(string $id)
    {
        $order_query = Order::query();
        $order_query->where('delivery_status', '!=', 'delivered');
     ...
     * @return \Illuminate\Http\Response
     */
    public function cancelled_delivery(string $id)
    {
        $order_query = Order::query();
        $order_query->where('delivery_status', 'cancelled');
    ...
    public function earning(string $id)
    {
        $collection_query = DeliveryHistory::query();
        $collection_query->where('delivery_status', 'delivered');
    ...
    public function collection_summary(string $id)
    {
        $collection_query = DeliveryHistory::query();
        $collection_query->where('delivery_status', 'delivered');
        $collection_query->where('payment_type', 'cash_on_delivery');
    ...
    public function earning_summary(string $id)
    {
        $collection_query = DeliveryHistory::query();
        $collection_query->where('delivery_status', 'delivered');
     ...
     * @return \Illuminate\Http\Response
     */
    public function change_delivery_status(ChangeDeliveryStatusRequest $request)
    {
    ...
    public function cancel_request(string $id)
    {
        $order =  Order::find($id);
