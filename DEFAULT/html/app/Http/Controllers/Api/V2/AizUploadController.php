...
use App\Http\Requests\Upload\AizUploadRequest;
use App\Http\Requests\Upload\GetPreviewFilesRequest;
use App\Http\Requests\Upload\IdRequest;
use App\Http\Requests\Upload\IdsRequest;
use App\Http\Requests\Upload\SearchRequest;
...
class AizUploadController extends Controller
{
    ...
    public function upload(AizUploadRequest $request)
    {
        $type = array(
            "jpg" => "image",
            "jpeg" => "image",
    ...
    public function get_uploaded_files(SearchRequest $request)
    {
    ...
    public function destroy(string $id)
    {
        ...
        try {
            if (env('FILESYSTEM_DRIVER') == 'aws') {
                Storage::disk('aws')->delete($upload->file_name);
    ...
    public function bulk_uploaded_files_delete(IdsRequest $request)
    {
        if ($request->id) {
    ...
    public function get_preview_files(GetPreviewFilesRequest $request)
    {
    ...
    public function attachment_download(string $id)
    {
    ...
    //Download project attachment
    public function file_info(IdRequest $request)
    {
