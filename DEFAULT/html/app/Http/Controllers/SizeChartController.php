...
use App\Http\Requests\SizeChart\GetCombinationRequest;
use App\Http\Requests\SizeChart\StoreRequest;
...
class SizeChartController extends Controller
{
    ...
    public function create()
    {
        ...
        $sizeOptions = AttributeValue::whereHas('attribute', function ($q) {
            $q->where('name', 'Beden');
            $q->orWhere('name', 'size');
        })
        ->selectRaw('id,value')->orderBy('created_at', 'asc')->get();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(StoreRequest $request, SizeChart $size_chart)
    {
    ...
    public function get_combination(GetCombinationRequest $request)
    {
