...
use App\Http\Requests\NewsLetter\SendRequest;
use App\Http\Requests\NewsLetter\TestEmailRequest;
use App\Models\User;
...
class NewsletterController extends Controller
{
    public function __construct() {
        ...
        $this->middleware(['permission:send_newsletter'])->only('index' , 'send' , 'testEmail');
    }
