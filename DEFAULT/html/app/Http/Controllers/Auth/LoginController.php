    ...
    */
    ...
    public function redirectToProvider($provider)
    {
        if (request()->has('invite_code')) {
            request()->session()->put('invite_code', request()->get('invite_code'));
        }
    ...
    public function handleAppleCallback()
    {
        ...
        if (get_setting('invite_system') == 1 && isset($invite_code) && $invite_code != null) {
            $invited_by_user = User::where('invitation_code', $invite_code)->first();
            if (!$invited_by_user) {
                flash(translate('Invited user not found'))->warning();
                return back();
            }
        }
        ...
        if ($existingUserByProviderId) {
            ...
            if(get_setting('invite_system') == 1 && isset($invite_code) && $invite_code != null){
                $invited_by_user = User::where('invitation_code', $invite_code)->first();
                if($invited_by_user && $user->email != null){
    ...
    public function account_deletion(Request $request)
    {
        ...
        flash(translate("You can not delete your account , your balance must be zero ."))->warning();
