...
use App\Http\Requests\SupportTicket\AdminIndexRequest;
use App\Http\Requests\SupportTicket\AdminStoreRequest;
use App\Http\Requests\SupportTicket\SellerStoreRequest;
use App\Http\Requests\SupportTicket\StoreRequest;
...
class SupportTicketController extends Controller
{
    ...
    public function admin_index(AdminIndexRequest $request)
    {
        $sort_search = null;
    ...
    public function admin_store(AdminStoreRequest $request)
    {
    ...
    public function seller_store(SellerStoreRequest $request)
    {
        $ticket_reply = new TicketReply;
        $ticket_reply->ticket_id = $request->ticket_id;
