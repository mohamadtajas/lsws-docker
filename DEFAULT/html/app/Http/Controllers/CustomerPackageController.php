...
use App\Http\Requests\CustomerPackage\EditRequest;
use App\Http\Requests\CustomerPackage\PurchaseOfflineRequest;
use App\Http\Requests\CustomerPackage\PurchaseRequest;
use App\Http\Requests\CustomerPackage\StoreRequest;
use App\Http\Requests\CustomerPackage\UpdateRequest;
...
class CustomerPackageController extends Controller
{
    ...
    public function purchase_package(PurchaseRequest $request)
    {
    ...
    public function purchase_payment_done($payment_data)
    {
        $user = User::findOrFail(Auth::user()->id);
    ...
    public function purchase_package_offline(PurchaseOfflineRequest $request)
    {
