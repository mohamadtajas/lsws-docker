...
use App\Http\Requests\FlashDeal\EditProductDiscountRequest;
use App\Http\Requests\FlashDeal\LangRequest;
use App\Http\Requests\FlashDeal\ProductDiscountRequest;
use App\Http\Requests\FlashDeal\SearchRequest;
use App\Http\Requests\FlashDeal\StoreRequest;
use App\Http\Requests\FlashDeal\UpdateFeaturedRequest;
use App\Http\Requests\FlashDeal\UpdateStatusRequest;
...
class FlashDealController extends Controller
{
    ...
    public function update_featured(UpdateFeaturedRequest $request)
    {
    ...
    public function product_discount(ProductDiscountRequest $request)
    {
        $product_ids = $request->product_ids;
        return view('backend.marketing.flash_deals.flash_deal_discount', compact('product_ids'));
    }

    public function product_discount_edit(EditProductDiscountRequest $request)
    {
        $product_ids = $request->product_ids;
