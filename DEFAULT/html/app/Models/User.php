...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    public function invitedUsers(){
        return $this->hasMany(Invitation::class , 'invited_by_user' , 'email')->where('used' , 1);
    }

    public function pendingInvitedUsers(){
        return $this->hasMany(Invitation::class , 'invited_by_user' , 'email')->where('used' , 0);
    }

    public function invitation(){
        return $this->hasMany(Invitation::class , 'invited_user' , 'email')->where('used' , 0);
    }
}
